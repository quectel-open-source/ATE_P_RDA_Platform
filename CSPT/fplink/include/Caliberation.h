...
public:
    ...
    virtual int burnRFData(FlashProgram* programmer, const FlashInfo& falshInfo, const QList<LodData*> &lods) = 0;
    ...
    enum { CALIB_FLAG = 31,
           ...
           CALIB_DCS_AFC = 4,
           CALIB_PCS_AFC = 5,
           CALIB_GSM850_Profile = 6,
           CALIB_EGSM_Profile = 7,
           CALIB_DCS_Profile = 8,
           CALIB_PCS_Profile = 9,
           CALIB_GSM850_APC = 10,
           CALIB_EGSM_APC = 11,
    ...
    virtual int dump_parameters(const QString& fname, bool automaticTool) = 0;
	...
	virtual int nbiot_mode_tx_fastpower(uint8_t band, uint16_t arfcn, int16_t power,uint8_t friststate)=0;
	...
	virtual int nbiot_set_tx_fastpwroffset(uint8_t band, int16_t &targetpwrnum,int16_t *targetpower,uint16_t &nextarfcn,int16_t measpwrnum, int16_t *meastxpower,bool&stop)=0;
	...
	virtual int Nbiot_NsftRxMeasure(float* measber,uint8_t band, uint16_t arfcn,int16_t rxpower, int)=0;
	virtual int Nbiot_NsftTxMeasure(uint8_t band, uint16_t arfcn, int16_t power)=0;
	virtual int nbiot_mode_rx_power_debug(uint8_t band, uint16_t arfcn, int16_t expPow,uint8_t friststate)= 0;	
	virtual int nbiot_mode_tx_power_debug(uint8_t band, uint16_t arfcn, int16_t power,uint8_t friststate)= 0;
