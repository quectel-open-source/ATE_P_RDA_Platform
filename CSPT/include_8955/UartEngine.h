...
public:
    ...
    int getFlowCtrl() const { return mFlowCtrl; }

    uint32_t getDefaultReadTimeout() { return mDefaultReadTimeoutMs; }
    uint32_t getDefaultWriteTimeout() { return mDefaultWriteTimeoutMs; }
