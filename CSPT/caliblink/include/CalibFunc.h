...
CALIBLINK_API int ReadBSN(TargetConnectionWrapper *conn,char* dataBuf,bool checkBit);
...
CALIBLINK_API int NbiotCalibItemsProcess(CRda2GCalib* instrument,int NBCalibItemsRet[48]);
...
CALIBLINK_API int NbiotCouplingPrepare(TargetConnectionWrapper* conn, bool flag);
CALIBLINK_API int NbiotChannel(int band,int txarfcn,int *rxarfcn);
CALIBLINK_API int NbiotTxCouplingProcess(TargetConnectionWrapper* conn,CRda2GNsft* instrument);
CALIBLINK_API int NbiotRxCouplingProcess(TargetConnectionWrapper* conn,CRda2GNsft* instrument);
...
CALIBLINK_API int NbiotTxCouplingItems(int band, unsigned int txarfcn, float txpower,float rxpower, CRda2GNsft* instrument);
CALIBLINK_API int NbiotRxCouplingItems(int band, unsigned int txarfcn, float txpower,float rxpower, CRda2GNsft* instrument);
CALIBLINK_API int NbiotCalibFastPaOffset(CRda2GCalib* instrument,int band, int arfcn, float txpower, bool state);
