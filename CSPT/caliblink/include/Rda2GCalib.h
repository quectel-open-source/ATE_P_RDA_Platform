...
public:
	...
	virtual float  CalibMakeGolden(unsigned char, short, float)=0;
...
//  virtual void CopulingSetPcsILoss() = 0;
    ...
    //nbiot
    virtual void NbiotCalibInit() = 0;
    virtual int  NbiotCalibAfcGain(int, int,float,int)=0;
    virtual int  NbiotCalibILoss(int, unsigned short,float,int)=0;
    virtual int  NbiotCalibPaOffset(int, unsigned short,float,int)=0;
    virtual int  NbiotCalibPaPro(int, unsigned short,float,int)=0;
    virtual int  NbiotCalibCrystal(int, int,float,int)=0;
	virtual float NbiotCalibTxLoss(int band, int arfcn,float txpower,int state)=0;
	virtual float NbiotCalibMakeGolden(int band, int arfcn,float ILoss,int state)=0;
	virtual int NbiotInstrFastMode(bool )=0;
	virtual int NbiotFastSetPowOffset(int band,int arfcn,int slotcount, float* targetpwr)=0;
	virtual int NbiotFastGetPowOffset(int slotcount,float* power)=0;

public:
	int NbiotChan2Freq(int band,int arfcn,float *DlFreq,float *UlFreq,int DL_UL);
	float NBiotCableLossCal(int band,unsigned short arfcn,int DL_UL);
