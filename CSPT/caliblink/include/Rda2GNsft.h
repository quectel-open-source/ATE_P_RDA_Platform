...
public:
    ...
    //nbiot
    virtual void NbiotNstInit() = 0;
    virtual int NbiotNstMeasSetup(int,int,float) = 0;
    virtual int NbiotNstCellSetup(int,int,float)=0;
    virtual int NbiotMeasureTxPower(float*,float*,float*) = 0;
    virtual int NbiotMeasureTxOBW(float*,float*)=0;
    virtual int NbiotMeasureTxSEM()=0;
    virtual int NbiotMeasureTxACLR(struct NB_NS_TEST_ACLR * m_nb_aclr)=0;
