...
CALIBLINK_API int CalibItemsProcess_Quectel(volatile unsigned int &calib_items, unsigned int CalibItemNum[4][5], unsigned int chipID, int maj_ver, int min_ver, CRda2GCalib* instrument,int ResultFlag[]);
