...
CALIBLINK_API int CalibItemsProcess(volatile unsigned int &calib_items, unsigned int CalibItemNum[4][5], unsigned int chipID, int maj_ver, int min_ver, CRda2GCalib* instrument);
...
CALIBLINK_API int NSTestItemProcess(char band, unsigned int tch, unsigned int bch, char pcl,int times, CRda2GNsft* instrument);
...
CALIBLINK_API void NSTestPrintBandInfo(char band, unsigned int tch, unsigned int bch, char pcl);
CALIBLINK_API void CouplingPrintBandInfo(char band, unsigned int tch, unsigned int bch, char pcl);
CALIBLINK_API int TestItems(bool NStest, char band, unsigned int tch, unsigned int bch, char pcl,int times, CRda2GNsft* instrument);
...
CALIBLINK_API int NbiotCalibItemsProcess(volatile unsigned int &calib_items, unsigned int CalibItemNum[4][5],CRda2GCalib* instrument);
CALIBLINK_API int NbiotBurnFlash(void);
CALIBLINK_API int NbiotNsftItemsProcess(TargetConnectionWrapper* conn,CRda2GNsft* instrument);
CALIBLINK_API int NbiotNSTestItemProcess(int band, unsigned int txarfcn, float txpower, float rxpower,CRda2GNsft* instrument);
