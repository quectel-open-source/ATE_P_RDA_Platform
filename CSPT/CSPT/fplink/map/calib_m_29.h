...
/// Number of TX power parameters for the transceiver.
#define CALIB_NB_XCV_TX_PARAM_QTY                  (120)
...
#define CALIB_NB_MAX_EXTRA_BAND_NUM                (15)
#define CALIB_NB_MAX_TX_POWER_NUM                  (10)
...
// ============================================================================
// CALIB_NB_XCV_TX_PARAM_T
// =============================================================================
typedef UINT32 CALIB_NB_XCV_TX_PARAM_T[CALIB_NB_XCV_TX_PARAM_QTY];
...
typedef struct {
    ...
    CALIB_NB_XCV_TX_PARAM_T            txparam;                      //0x00000078
} CALIB_NB_XCV_T; //Size : 0xA8

// ============================================================================
// CALIB_NB_XCV_ELEMENT_EXTRA_T
// -----------------------------------------------------------------------------
/// Transceiver calibration element for NBIOT bands except 1,2,3,5,8,20,28.
// =============================================================================
typedef struct
{
	// 1 rxILoss per subbands, and max 5 subbands per band
	UINT8                             rxILoss[36];                  //0x00000000
	// 20 anaGain per subBand, and max 5 subbands per band
	UINT8                             txILoss[100];                //0x00000008
} CALIB_NB_XCV_ELEMENT_EXTRA_T; //Size : 108 Byte

// ============================================================================
// CALIB_NB_XCV_EXTRA_T
// -----------------------------------------------------------------------------
/// Transceiver calibration for NBIOT bands except 1,2,3,5,8,20,28.
// =============================================================================
typedef struct
{
	CALIB_NB_XCV_ELEMENT_EXTRA_T      bandParam[CALIB_NB_MAX_EXTRA_BAND_NUM];               //0x00000000
} CALIB_NB_XCV_EXTRA_T; //Size : 108*13 Byte
...
typedef struct {
    ...
    UINT32                            reserved1;                    //0x00001CEC  rfRestore tool tag
    UINT32                            reserved2;                    //0x00001CEC   rfRestore tool tag
    /// CRC value for RF CALIBration data.
    CALIB_NB_RF_CRC_T                 rfCrc;                        //0x00001CF8

    /// Transceiver calibration for extra bands except 1,2,3,5,8,20,28
    CALIB_NB_XCV_EXTRA_T              xcv2;                         //0x00001CFC
    /// CRC value for RF calibration data.
    CALIB_NB_RF_CRC_T                 rfCrc2;
} CALIB_NB_BUFFER_T; //Size : 0xAE4
...
typedef enum {
	...
	CALIB_NB_STUB_CONN_RX_STATE                      = 0x0000000A,
	CALIB_NB_STUB_CONN_TX_STATE                      = 0x0000000B,
	CALIB_NB_STUB_FORCE_RX_STATE                     = 0x0000000C,
	CALIB_NB_STUB_FORCE_TX_STATE                     = 0x0000000D,
	CALIB_NB_STUB_SHUTDOWN_STATE                     = 0x0000000F,
	CALIB_NB_STUB_FAST_TX_STATE                      = 0x00000011,
} CALIB_NB_STUB_CMDS_T;
...
typedef struct {
	...
	VOLATILE UINT16                TargetTxPwrNum;                        //0x000004F8
	VOLATILE INT16                 TargetTxPwr[CALIB_NB_MAX_TX_POWER_NUM];           //0x000004FC
	VOLATILE UINT16                MeasTxPwrNum;                      //0x000004FC
	VOLATILE INT16                 MeasTxPwr[CALIB_NB_MAX_TX_POWER_NUM];             //0x000004FC
...
typedef struct {
    ...
    CALIB_NB_XCV_EXTRA_T*             xcv2;                         //0x00000028                  //0x00000014
    VOLATILE CALIB_NB_XCV_EXTRA_T*    hstXcv2;                      //0x0000002C
